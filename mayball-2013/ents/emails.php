...
function create_audition_email($name, $phone, $act_name, $datetime) {
	...
	$message .= "Thank you for applying to perform at Jesus May Ball 2013. Please check that all of the details below are correct: \n\n";
	...
	$message .= "Please come to the Picken Room in Jesus College 20 minutes before your audition time. An electric piano and drum kit will be provided for musical acts; please bring any other equipment you require. Each audition slot is 15 minutes long.\n\nPlease contact mayball-ents@jesus.cam.ac.uk with any queries. We look forward to seeing you soon,\n\nEleano, Claire and Zachary \n";
	return $message;
}
