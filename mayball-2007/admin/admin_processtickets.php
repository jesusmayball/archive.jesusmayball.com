...
if (!$error) {
  ...
  echo "<a href=\"http://www-jcsu.jesus.cam.ac.uk/~mayball/admin/admin_confirm.php?authString=".$application->authString."\">Add this application and request payment</a><br />";
  echo "<a href=\"http://www-jcsu.jesus.cam.ac.uk/~mayball/admin/admin_confirm_paid.php?authString=".$application->authString."\">Add this application and set as paid.</a><br />";
